...
function Approval() {
  ...
  const fetchNewProducts = async () => {
    ...
    try {
      ...
      const mockProducts = [
        { productId: 1, productName: "New Cake", productStatus: false },
        { productId: 2, productName: "New Cookie", productStatus: false }
      ];
  ...
  const fetchNewOutlets = async () => {
    ...
    try {
      ...
      // Mock data for development
      const mockOutlets = [
        { outletId: 1, outletName: "New Branch", status: "Inactive" }
      ];
      setNewOutlets(mockOutlets);
    } catch (error) {
  ...
  const fetchPriceUpdates = async () => {
    ...
    try {
      ...
      const mockPriceUpdates = [
        { productId: 1, price: 29.99, date: new Date() }
      ];
