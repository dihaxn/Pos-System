...
// import AuthContext from "../../context/AuthContext"; // Commented for development // Import your AuthContext if needed
    ...
    useEffect(() => {
        const fetchReturns = async () => {
          try {
            ...
            const response = await axios.get(`${config.RETURN_API_URL}${config.ENDPOINTS.RETURN.ALL_BY_OUTLET_ID}`, {
                            ...
                            {loadingItems ? (
                              ...
                              <div>
                                <table className="min-w-full bg-white border border-gray-200 rounded-xl shadow">
                                  ...
                                  <tbody className="text-gray-600 text-sm">
                                    {returnItem.returnItems && returnItem.returnItems.length > 0 ? returnItem.returnItems.map((item) => (
