...
const NotificationButton = () => {
  ...
  const toggleNotifications = () => {
    ...
    fetchNotifications(1); // Hardcoded for development
    setIsOpen(true);
  };
  ...
  const fetchNotifications = async (id) => {
    try {
      ...
      setNotifications([
        "System: Welcome to development mode [Jan 19, 10:30 AM]",
        "Info: Authentication bypassed for development [Jan 19, 10:25 AM]"
      ]);
    } catch (error) {
