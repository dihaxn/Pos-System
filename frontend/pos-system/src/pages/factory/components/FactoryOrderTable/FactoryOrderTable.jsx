...
import OrderTable from "../../../outlet/components/PosTable/OrderTable.jsx";
...
} from "../../../outlet/services/outlet_service/factoryOrderController";
import LoadingPopup from "../../../shared/components/Popup/LoadingPopup/LoadingPopup.jsx";
import { saveNotification } from "../../../owner/services/reporting_service/notificationController";
                  ...
                  <td colSpan="7" className="py-12 text-center">
                    <div className="flex flex-col items-center justify-center space-y-4">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-sm text-gray-400 mt-1">Try changing the status filter or search terms.</p>
                      </div>
                    </div>
                  </td>
                </tr>
